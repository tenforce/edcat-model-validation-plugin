...
/**
 * This error shows that the specification for a QueryResultConstraint could not be parsed into
 * a valid QueryResultConstraint.  This occurs when the supplied information was not sufficient
 * or was invalid.
 */
