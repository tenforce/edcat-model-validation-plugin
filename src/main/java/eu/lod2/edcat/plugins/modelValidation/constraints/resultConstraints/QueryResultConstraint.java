 ...
 * through the use of SPARQL queries.  The result of such a query must abide certain constraints
 * in order for the model to be valid.  It is exactly this, which is checked through an instance
 * of this class.
 */
