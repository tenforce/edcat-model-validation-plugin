...
public class QueryResultConstraintBuilder {
   ...
   *                                               lacking information.
   */
  public static QueryResultConstraint fromSparql( URI constraintURI ) throws UnknownQueryResultConstraintException {
    Map<URI, String> settings = constraintConfigParameters( constraintURI );
    try {
   ...
   */
  private static Map<URI, String> constraintConfigParameters( URI constraint ) {
    // fetch results
